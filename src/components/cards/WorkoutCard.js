...
const WorkoutCard = ({workout, isAuthUser}) => {

    return (
        <div
            className="relative h-60 rounded-lg flex flex-col justify-end text-white overflow-hidden hover:bg-secondary cursor-pointer">
