...
const WorkoutCard = ({workout}) => {
    ...
    return (
        <div className={`relative bg-[url(https://${workout.thumbnailUrl})] h-60 bg-no-repeat bg-cover bg-center rounded-lg p-2 flex flex-col justify-end text-white overflow-hidden hover:bg-transparentBlack`}>
