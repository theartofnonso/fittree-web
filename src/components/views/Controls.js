...
const Controls = (props) => {
    ...
    return (
        <div
            className={`relative ${isRepsSets ? "h-24" : "h-12"} flex flex-col bg-whiteOpacity1 justify-center items-center w-48 rounded-lg text-white font-semibold shadow-darkSecondary shadow-md hover:bg-darkPrimary`}>
            ...
            <div
                ...
                <div className="flex flex-row">
                    ...
                    <button type="button" className="mx-3" onClick={props.pause}>
                        <PauseIcon/>
                    </button>
                    <button type="button" className="" onClick={props.next}>Next</button>
                </div>
                {isRepsSets ? <div className="flex flex-row">
                    <button type="button" className="mx-4 p-2 bg-secondary rounded" onClick={props.prevExercise}>
                        <SkipBackwardIcon/>
                    </button>
                    <button type="button" className="mx-4 p-2 bg-secondary rounded" onClick={props.skipExercise}>
                        <SkipForwardIcon/>
                    </button>
                </div> : null}
            </div>
