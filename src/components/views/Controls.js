...
const Controls = (props) => {
    ...
    return (
        <div className="flex flex-row bg-primary justify-center w-48 rounded-full space-x-4 py-2 px-3 text-white font-semibold shadow-lightSecondary shadow-md hover:bg-darkPrimary">
