...
const WorkoutCard = ({workout}) => {
    ...
    return (
        <div
            className="relative h-52 rounded-lg flex flex-col justify-end text-white overflow-hidden hover:bg-black cursor-pointer">
            <img src="/wallpaper.jpg" alt="Display profile" className="object-cover h-full w-full object-top"/>
