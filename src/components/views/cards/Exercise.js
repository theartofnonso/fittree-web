...
const Exercise = ({isActive, exercise, setIndex, duration, timeLeft, workoutType}) => {
    ...
    return (
        <div className={`flex flex-row items-center place-content-between py-2 px-4 mt-2 mb-4 ${isActive ? "bg-primary bg-[url('/circuit-board.svg')]" : "shadow-darkSecondary shadow-lg "} w-full rounded-sm`}>
