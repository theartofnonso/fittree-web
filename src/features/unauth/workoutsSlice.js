 ...
 */
export const listWorkouts = createAsyncThunk("workouts/getAll", async (payload, { rejectWithValue }) => {
  try {
 ...
 * @type {AsyncThunk<unknown, void, {}>}
 */
export const createWorkout = createAsyncThunk("workouts/create", async (payload, { rejectWithValue }) => {
 ...
 * @type {AsyncThunk<unknown, void, {}>}
 */
export const updateWorkout = createAsyncThunk("draftWorkouts/update", async (payload, { rejectWithValue }) => {
 ...
 * @type {AsyncThunk<unknown, void, {}>}
 */
export const deleteWorkout = createAsyncThunk("workouts/delete", async (payload, { rejectWithValue }) => {
 ...
 * @type {AsyncThunk<unknown, void, {}>}
 */
export const batchDeleteWorkouts = createAsyncThunk("workouts/deleteAll", async (payload, { rejectWithValue }) => {
